...
const routes: Routes = [
  { path: "investor-registration", component: InvestorRegistrationComponent },
  { path: "investor-preferences/:id", component: InvestorPreferencesComponent },
  { path: "complete-investor-registration", component: CompleteInvestorRegistrationComponent },
];
